                    ...
                    <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
                        ...
                        <div class="order-3 xl:order-2">
                            ...
                            <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ docenteData.TipoInfPer }}</p>
                            </div>
                        </div>
    ...
    methods: {
        ...
        async buscarDocente() {
            ...
            try {
                ...
                // Si el docente está registrado, podrías disparar la verificación de fotos automáticamente
                console.log("Docente cargado:", this.docenteData);
        ...
        async checkRegistro() {
            ...
            try {
                const response = await API.get(`/registro/check/${this.searchQuery}`);
                this.estaRegistrado = response.data.registered;
            } catch (error) {
                console.error("Error checking registro:", error);
                this.estaRegistrado = false;
            }
        },
